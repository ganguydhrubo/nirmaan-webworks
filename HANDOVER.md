# Nirmaan Webworks · End-to-End Handover Brief & Production Deployment Guide
...
| :--- | :--- |
| **Project Name** | **Nirmaan Webworks** (Bespoke Web Engineering for Indian MSMEs & Local Businesses) |
| **Version** | `0.1.0` (Production Ready) |
| **Active Local Server** | `http://127.0.0.1:4321` (Self-hosted preview running on Cloudflare Workers runtime) |
| **GitHub Repository** | [https://github.com/ganguydhrubo/nirmaan-webworks](https://github.com/ganguydhrubo/nirmaan-webworks) |
...
- **Repository Link:** [https://github.com/ganguydhrubo/nirmaan-webworks](https://github.com/ganguydhrubo/nirmaan-webworks)
...
3. Select your GitHub account `ganguydhrubo` and import `nirmaan-webworks`.
...
| :--- | :--- | :--- |
| `PUBLIC_SITE_URL` | `https://nirmaanwebworks.in` (or your Vercel URL) | Canonical URL root |
...
6. **Dual-Engine Architecture (Zero-Downtime Guarantee):**
   ...
   - If no API key is supplied or the API is unreachable, seamlessly activates Nirmaan's built-in deterministic heuristic CRO engine, guaranteeing the tool always renders instant, accurate reports.
7. **End-to-End Lead Engine Integration:**
   - Direct CTA links pre-filled with the audit score and business name to Nirmaan's `/contact#enquiry` form and WhatsApp desk.

---

## 5. Master Checklist of All Required Tools & Accounts

To run Nirmaan Webworks and client projects at maximum efficiency, here is the full breakdown of required tools across categories:
...
- [ ] **Resend Transactional Email API Key (`RESEND_API_KEY`)**:
  ...
  - *Usage:* Instant lead notification delivery to `founder@nirmaanwebworks.in`.
...
- [ ] **WhatsApp Business App**: Set up with business profile, catalog, and automated greeting matching Nirmaan's templates.
- [ ] **Google Business Profile (GBP)**: Register Nirmaan Webworks with address `Salt Lake, Sector V, Kolkata 700091` to capture local agency searches.
- [ ] **Google Search Console**: Submit sitemap `https://www.nirmaanwebworks.in/sitemap-index.xml`.

---

## 6. Verification & Health Commands

Run these commands inside `C:\Users\Dhrubo\nirmaan-webworks` to verify the codebase at any time:
