...
const raw: IndustryContent[] = [
  ...
  {"slug":"professional-services","intro":"Clear scopes and a thoughtful first conversation help owner-led businesses choose an adviser with confidence.","painPoints":["Expertise is buried in generic service lists","Prospects cannot understand the engagement process","Enquiries arrive without context"],"features":[{"title":"Interactive brief builder","body":"Help visitors identify the question they want to explore."},{"title":"Clear practice areas","body":"Explain scope, deliverables and boundaries."},{"title":"Editorial identity","body":"Make expertise visible with confident typography and useful content."}],"localSeoBlurb":"We structure real professional services websites around relevant service, product and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},  {"slug":"fitness-studios","intro":"A studio website should make it easy to choose a training format, find a time and understand the commitment.","painPoints":["Timetables only exist in social posts","Visitors cannot compare formats and durations","Membership details hide the commitment"],"features":[{"title":"Class finder","body":"Filter the sample week by day and training format."},{"title":"First-visit guidance","body":"Explain arrival, equipment and how coaching adapts to new members."},{"title":"Transparent membership","body":"Show rupee pricing, validity and inclusions."}],"localSeoBlurb":"We structure real fitness studios websites around relevant service, product and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},  {"slug":"events-photography","intro":"Couples choose an atmosphere before they compare a package. A cinematic portfolio can still answer practical questions about coverage and delivery.","painPoints":["Images disappear into an endless social feed","Coverage and deliverables are difficult to compare","Enquiries omit dates and event scope"],"features":[{"title":"Immersive story gallery","body":"Explore an editorial narrative with keyboard-accessible full-screen viewing."},{"title":"Coverage clarity","body":"Explain events, hours, deliverables and exclusions."},{"title":"Considered enquiry path","body":"Give couples a useful checklist for the first conversation."}],"localSeoBlurb":"We structure real events & photography websites around relevant service, product and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},  {"slug":"retail-d2c","intro":"A local shop can offer a useful online catalogue before it needs checkout. Product details and a personal enquiry bridge the screen and the store.","painPoints":["Product information is scattered across messages","Customers cannot browse a coherent catalogue","Enquiries arrive with screenshots rather than product names"],"features":[{"title":"Browsable product catalogue","body":"Filter pieces by category with all items accessible without JavaScript."},{"title":"Product quick views","body":"See material, dimensions, price and care without losing your place."},{"title":"Product-aware enquiries","body":"Carry a named piece into an enquiry about a catalogue website."}],"localSeoBlurb":"We structure real retail & boutiques websites around relevant service, product and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},  {"slug":"automotive","intro":"A buyer weighing a serious purchase wants real condition detail, not just a flattering photo. A clear inspection story builds the trust a showroom visit depends on.","painPoints":["Listings show a photo and a price with no condition detail","Buyers cannot tell what an inspection actually covers","Service enquiries arrive without a clear scope or budget"],"features":[{"title":"Interactive inspection explorer","body":"Walk through body, mechanical and cabin checkpoints before a visit."},{"title":"Transparent sample specs","body":"Show vehicle details and what the asking price does and doesn't include."},{"title":"Service brief builder","body":"Let visitors assemble a sample workshop brief with upfront pricing."}],"localSeoBlurb":"We structure real automotive dealer and workshop websites around relevant service, model and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},  {"slug":"diagnostics-labs","intro":"A patient booking a test wants to know what it involves and, later, how to read the result — not a wall of medical jargon. Clear structure builds the trust a lab depends on.","painPoints":["Test information is scattered across phone calls and old prescriptions","Patients cannot tell what preparation a test actually needs","A report arrives with no explanation of what it means"],"features":[{"title":"Searchable test directory","body":"Specimen, preparation and turnaround for every listed test, without a phone call."},{"title":"Report walkthrough","body":"A plain-language guide to what each part of a report means — never a diagnosis."},{"title":"Clear collection journey","body":"Show patients exactly what happens between booking and a signed-off report."}],"localSeoBlurb":"We structure real diagnostics lab websites around relevant test, panel and locality searches, using accurate information supplied by the business. Fictional demos remain noindex."},
];
